...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_background_optional = 24        /* background_optional  */
};
...
{
       0,    42,    42,    46,    47,    51,    54,    55,    59,    60,
      64,    64,    72,    74,    80,    81,    85,    93,   101,   111,
     119,   128,   141,   144
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREAT", "NEWLINE", "LESS", "GREATGREAT", "GREAT2", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "PIPE", "AMPERSAND", "$accept", "goal",
  "command_list", "command_line", "pipe_list", "cmd_and_args", "$@1",
  "arg_list", "io_modifier_list", "io_modifier", "background_optional", YY_NULLPTR
};
...
{
       0,     0,    10,     6,     0,     0,     3,    15,     8,     7,
      12,     1,     4,     0,    23,    11,     9,     0,     0,     0,
       0,     0,     0,    22,    14,     0,    13,    17,    21,    16,
      19,    20,    18,     5
};
...
static const yytype_int8 yystos[] =
{
      ...
      20,     0,    17,    12,    22,    21,    19,     5,     7,     8,
       9,    10,    11,    13,    23,    24,     3,     3,     3,     3,
       3,     3,     3,     6
};
...
#line 1119 "shell.tab.c"
    break;

  case 11: /* cmd_and_args: WORD $@1 arg_list  */
#line 67 "shell.y"
                 {
         Shell::_currentCommand.insertSimpleCommand(Command::_currentSimpleCommand);
      }
#line 1127 "shell.tab.c"
    break;

  case 13: /* arg_list: arg_list WORD  */
#line 74 "shell.y"
                    {
         Command::_currentSimpleCommand->insertArgument((yyvsp[0].cpp_string));
      }
#line 1135 "shell.tab.c"
    break;

  case 16: /* io_modifier: GREATGREAT WORD  */
#line 85 "shell.y"
                      {
        #ifdef PRINTING
...
#line 1148 "shell.tab.c"
  ...
  case 17: /* io_modifier: GREAT WORD  */
#line 93 "shell.y"
                 {
      #ifdef PRINTING
...
#line 1161 "shell.tab.c"
    break;

  case 18: /* io_modifier: GREATGREATAMPERSAND WORD  */
#line 101 "shell.y"
                               {
      #ifdef PRINTING
...
#line 1175 "shell.tab.c"
    break;

  case 19: /* io_modifier: GREAT2 WORD  */
#line 111 "shell.y"
                  {
      #ifdef PRINTING
...
#line 1214 "shell.tab.c"
    break;

  case 22: /* background_optional: AMPERSAND  */
#line 141 "shell.y"
                {
